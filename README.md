...
- Press `Esc` to cancel a drag and leave the song in place
- Folders only render their songs when first expanded, keeping the initial load fast
...
- [ ] Sort options & advanced filtering within folders (by title, artist, or duration)
- [ ] Nested subfolders
